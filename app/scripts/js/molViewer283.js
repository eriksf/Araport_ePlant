...
(function() {
	...
	MolViewer = function(conf) {
		...
		*/
		...
		window[this.config.CSS.IDs.jsMolViewer+".setControls"]=$.proxy(this.setControls,this);
		/**
	...
	/**
		* 
	*/
	MolViewer.prototype.init = function() {		
		this.setLogger();
	...
	*/
	MolViewer.prototype.setLogger = function() {
	...
	/**
		* 
	*/
	MolViewer.prototype.ajaxGetCDDfeatures = function(fullseq) {
	...
	/**
		* 
	*/
	MolViewer.prototype.ajaxGetPfamDomains = function(fullseq) {
	...
	/**
		* 
	*/
	MolViewer.prototype.scrollLoggerToBottom = function() {
	...
	*/
	MolViewer.prototype.setResidue = function(residueSpan)  {
	...
	*/
	MolViewer.prototype.setResiduesByIndexes = function(domainSpan, arrayOfIndexes) {
	...
	/**
		* 
	*/
	MolViewer.prototype.resetJsmolColors = function() {
	...
	/**
		* set color by range
	*/
	MolViewer.prototype.setColorByRange = function(startIndex, endIndex) {
	...
	*/
	MolViewer.prototype.jq = function(myid) {	 
	...
	/**
		...
		* @return
	*/
	MolViewer.prototype.reloadModel = function() {
	...
	/**
		* 
	*/
	MolViewer.prototype.setBorderSequenceFades = function() {
	...
	/**
		* 
	*/
	MolViewer.prototype.createSlider = function() {
		return;//TODO remove
	...
	*/
	MolViewer.prototype.setControls = function(a,b,c,d,e,f,g,h) {
