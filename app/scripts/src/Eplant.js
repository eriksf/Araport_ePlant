(function() {
	...
	*/
	...
	Eplant.resize = function() {
		...
		var height = $(window).height(); // Araport
		var width = $(window) -leftMargin;	// Hardcoding 1140 for Araport
		...
		settings.width( $(window) - parseInt(settings.css('marginLeft'),10) ); // Araport
		$('div#tabUl').width( $(window) - parseInt(settings.css('marginLeft'),10) ); // Araport
