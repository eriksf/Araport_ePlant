(function() {
	...
	*/
	...
	Eplant.BaseViews.EFPView.PaletteDialog.prototype.setColors = function(min,mid,max) {
	...
	Eplant.BaseViews.EFPView.PaletteDialog.prototype.createPresetButton = function(min,mid,max) {
