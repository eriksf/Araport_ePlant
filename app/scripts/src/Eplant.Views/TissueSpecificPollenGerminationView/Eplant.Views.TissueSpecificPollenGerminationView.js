...
Eplant.Views.TissueSpecificPollenGerminationView = function(geneticElement) {
	...
	var efpSvgURL = 'app/data/experiment/efps/TissueSpecificPollenGermination/' + geneticElement.species.scientificName.replace(" ", "_") + '.svg';
	var efpXmlURL = 'app/data/experiment/efps/TissueSpecificPollenGermination/' + geneticElement.species.scientificName.replace(" ", "_") + '.xml';
...
Eplant.Views.TissueSpecificPollenGerminationView.viewName = "Tissue Specific Pollen Germination eFP";
