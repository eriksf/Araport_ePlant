 ...
 */
Eplant.Views.TissueSpecificShootApicalMeristemView = function(geneticElement) {
	// Get constructor
	var constructor = Eplant.Views.TissueSpecificShootApicalMeristemView;
	...
	var efpSvgURL = 'app/data/experiment/efps/TissueSpecificShootApicalMeristem/' + geneticElement.species.scientificName.replace(" ", "_") + '.svg';
	var efpXmlURL = 'app/data/experiment/efps/TissueSpecificShootApicalMeristem/' + geneticElement.species.scientificName.replace(" ", "_") + '.xml';
...
Eplant.Views.TissueSpecificShootApicalMeristemView.citation = "";
Eplant.Views.TissueSpecificShootApicalMeristemView.activeIconImageURL = "";
Eplant.Views.TissueSpecificShootApicalMeristemView.availableIconImageURL = "";
Eplant.Views.TissueSpecificShootApicalMeristemView.unavailableIconImageURL = "";
