...
Eplant.Views.TissueSpecificShootApicalMeristemView = function(geneticElement) {
	...
	var efpSvgURL = 'data/experiment/efps/TissueSpecificShootApicalMeristem/' + geneticElement.species.scientificName.replace(" ", "_") + '.svg';
	var efpXmlURL = 'data/experiment/efps/TissueSpecificShootApicalMeristem/' + geneticElement.species.scientificName.replace(" ", "_") + '.xml';
