(function() {
    ...
    Eplant.Views.TestView.prototype.loadsvg = function(svgimage) {
	    ...
	    $("g:not('#outlines') path", $svg).attr('fill', "transparent");
    ...
    Eplant.Views.TestView.prototype.bindSvgEvents= function() {
	...
	var showTooltip = function(event) {
	  $('div.tooltip').remove();
	  $('<div class="tooltip">'+group.id + '</br>Mean: ' + group.mean+'</br>Standard Error: '+ group.sterror+'</br>Sample Size: '+ group.samples.length+'</div>')
            .appendTo('body');
