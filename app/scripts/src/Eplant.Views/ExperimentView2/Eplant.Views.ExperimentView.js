...
Eplant.Views.ExperimentView.viewName = "Experiment Viewer";
...
Eplant.Views.ExperimentView.prototype.active = function() {
	...
	/* This might not be useful for experiment viewer */
	var choice = this.selectList.getChoiceByView(Eplant.activeSpecies);
	if (choice) {
		choice.select();
	}
